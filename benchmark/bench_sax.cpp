...
public:
  ...
  really_inline error_code start_document(json_iterator &) { return SUCCESS; }
  really_inline error_code start_object(json_iterator &) { return SUCCESS; }
  really_inline error_code key(json_iterator &, const uint8_t *key) {
    switch(key[0]) {
      case 'x':
        idx = 0;
        break;
  ...
  really_inline error_code primitive(json_iterator &, const uint8_t *value) {
    return numberparsing::parse_double(value).get(buffer[idx]);
  }
  really_inline error_code start_array(json_iterator &)  { return SUCCESS; }
  really_inline error_code end_array(json_iterator &) { return SUCCESS; }
  really_inline error_code end_object(json_iterator &)  { return SUCCESS; }
  really_inline error_code end_document(json_iterator &)  { return SUCCESS; }
  really_inline error_code empty_array(json_iterator &)  { return SUCCESS; }
  really_inline error_code empty_object(json_iterator &)  { return SUCCESS; }
  really_inline error_code root_primitive(json_iterator &, const uint8_t *)  { return SUCCESS; }
  really_inline void increment_count(json_iterator &) {}
