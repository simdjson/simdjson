...
template <>
int find_structural_bits<Architecture::WESTMERE>(const uint8_t *buf, size_t len, simdjson::ParsedJson &pj, size_t offset) {
  return westmere::find_structural_bits(buf, len, pj, offset);
}
