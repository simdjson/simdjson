...
struct tape_builder {
  ...
  WARN_UNUSED really_inline error_code visit_root_primitive(json_iterator &iter, const uint8_t *value) {
    switch (*value) {
  ...
  WARN_UNUSED really_inline error_code visit_primitive(json_iterator &iter, const uint8_t *value) {
    switch (*value) {
      case '"': return visit_string(iter, value);
  ...
  WARN_UNUSED really_inline error_code visit_empty_object(json_iterator &iter) {
    iter.log_value("empty object");
    return empty_container(iter, internal::tape_type::START_OBJECT, internal::tape_type::END_OBJECT);
  }
  WARN_UNUSED really_inline error_code visit_empty_array(json_iterator &iter) {
    iter.log_value("empty array");
    return empty_container(iter, internal::tape_type::START_ARRAY, internal::tape_type::END_ARRAY);
  }

  WARN_UNUSED really_inline error_code visit_document_start(json_iterator &iter) {
    iter.log_start_value("document");
    start_container(iter);
    iter.dom_parser.is_array[iter.depth] = false;
    return SUCCESS;
  }
  WARN_UNUSED really_inline error_code visit_object_start(json_iterator &iter) {
    iter.log_start_value("object");
    start_container(iter);
    iter.dom_parser.is_array[iter.depth] = false;
    return SUCCESS;
  }
  WARN_UNUSED really_inline error_code visit_array_start(json_iterator &iter) {
  ...
  WARN_UNUSED really_inline error_code visit_key(json_iterator &iter, const uint8_t *key) {
...
private:
  ...
  WARN_UNUSED really_inline error_code visit_string(json_iterator &iter, const uint8_t *value, bool key = false) {
  ...
  WARN_UNUSED really_inline error_code visit_number(json_iterator &iter, const uint8_t *value) {
    iter.log_value("number");
    if (!numberparsing::parse_number(value, tape)) { iter.log_error("Invalid number"); return NUMBER_ERROR; }
    return SUCCESS;
  }

  WARN_UNUSED really_inline error_code visit_root_number(json_iterator &iter, const uint8_t *value) {
    //
  ...
  WARN_UNUSED really_inline error_code visit_true_atom(json_iterator &iter, const uint8_t *value) {
    iter.log_value("true");
  ...
  WARN_UNUSED really_inline error_code visit_root_true_atom(json_iterator &iter, const uint8_t *value) {
    iter.log_value("true");
  ...
  WARN_UNUSED really_inline error_code visit_false_atom(json_iterator &iter, const uint8_t *value) {
  ...
  WARN_UNUSED really_inline error_code visit_root_false_atom(json_iterator &iter, const uint8_t *value) {
    iter.log_value("false");
  ...
  WARN_UNUSED really_inline error_code visit_null_atom(json_iterator &iter, const uint8_t *value) {
    iter.log_value("null");
  ...
  WARN_UNUSED really_inline error_code visit_root_null_atom(json_iterator &iter, const uint8_t *value) {
    iter.log_value("null");
