...
struct utf8_checker {
  ...
  //
  static constexpr uint8_t OVERLONG_2  = 0x01; // 1100000_         ________         Could have been encoded in 1 byte
  static constexpr uint8_t OVERLONG_3  = 0x02; // 11100000         100_____         Could have been encoded in 2 bytes
  static constexpr uint8_t SURROGATE   = 0x04; // 11101010         101_____         Surrogate pairs
  static constexpr uint8_t TOO_LARGE   = 0x08; // 11110100         (1001|101_)____ > U+10FFFF
  static constexpr uint8_t TOO_LARGE_2 = 0x10; // 1111(0101..1111) ________       > U+10FFFF
  static constexpr uint8_t OVERLONG_4  = 0x20; // 11110000         1000____         Could have been encoded in 3 bytes
