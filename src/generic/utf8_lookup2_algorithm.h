...
namespace utf8_validation {
  ...
  really_inline simd8<uint8_t> check_special_cases(const simd8<uint8_t> input, const simd8<uint8_t> prev1) {
    ...
    //
    static constexpr int OVERLONG_2  = 0x01; // 1100000_ 10______ (technically we match 10______ but we could match ________, they both yield errors either way)
    static constexpr int OVERLONG_3  = 0x02; // 11100000 100_____ ________
    static constexpr int OVERLONG_4  = 0x04; // 11110000 1000____ ________ ________
    static constexpr int SURROGATE   = 0x08; // 11101101 [101_]____
    static constexpr int TOO_LARGE   = 0x10; // 11110100 (1001|101_)____
    static constexpr int TOO_LARGE_2 = 0x20; // 1111(1___|011_|0101) 10______
    ...
    static constexpr int CARRY = OVERLONG_2 | TOO_LARGE_2;
  ...
  really_inline simd8<uint8_t> is_incomplete(simd8<uint8_t> input) {
    ...
    static constexpr uint8_t max_array[32] = {
