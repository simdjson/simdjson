...
simdjson_warn_unused uint8_t *dom_parser_implementation::parse_string_safe(const uint8_t *src, uint8_t *dst, bool replacement_char, const uint8_t *buf_end) const noexcept {
  return westmere::stringparsing::parse_string_safe(src, dst, replacement_char, buf_end);
}
...
simdjson_warn_unused uint8_t *dom_parser_implementation::parse_wobbly_string_safe(const uint8_t *src, uint8_t *dst, const uint8_t *buf_end) const noexcept {
  return westmere::stringparsing::parse_wobbly_string_safe(src, dst, buf_end);
}
