...
namespace object_tests {
  ...
  bool issue1965() {
    ...
    simdjson::singlestage::parser parser;
    simdjson::singlestage::document doc = parser.iterate(view);
    simdjson::singlestage::object root = doc.get_object();
    simdjson::singlestage::value query = root.find_field("query");
    simdjson::singlestage::raw_json_string raw = query.get_raw_json_string();
  ...
  bool issue1723_except() {
    ...
    simdjson::singlestage::document doc = parser.iterate(docdata);
    singlestage::object content = doc.get_object().find_field("contents");
    singlestage::array bids = content["bids"].get_array();
    ...
    singlestage::array asks = content["asks"].get_array();
  ...
  void broken_descend(singlestage::object node) {
    if(auto type = node.find_field_unordered("type"); type.error() == SUCCESS && type == "child") {
     ...
     for (singlestage::object child_node : node["nodes"]) { broken_descend(child_node); }
    }
  }
  ...
  bool broken_issue_1521() {
    ...
    singlestage::document file_tree = parser.iterate(json);
    try {
  ...
  // used in issue_1521
  // difficult to use as a lambda because it is recursive.
  void descend(singlestage::object node) {
    auto n = node.find_field_unordered("name");
    if(auto type = node.find_field_unordered("type"); type.error() == SUCCESS && type == "child") {
      if(n.error() == simdjson::SUCCESS) {
          std::cout << std::string_view(n) << std::endl;
     ...
     for (singlestage::object child_node : node["nodes"]) { descend(child_node); }
    }
  }
  ...
  bool iterate_object() {
    ...
    SUBTEST("singlestage::object-document-rewind", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_RESULT( doc_result.type(), json_type::object );
      ASSERT_SUCCESS( doc_result.get(object) );
      size_t i = 0;
    ...
    SUBTEST("singlestage::object-rewind", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_RESULT( doc_result.type(), json_type::object );
      ASSERT_SUCCESS( doc_result.get(object) );
      size_t i = 0;
    ...
    SUBTEST("simdjson_result<singlestage::object>", test_singlestage_doc(json, [&](auto doc_result) {
      simdjson_result<singlestage::object> object_result = doc_result.get_object();
      size_t i = 0;
  ...
  bool iterate_object_partial_children() {
    ...
    SUBTEST("singlestage::object", test_singlestage_doc(json, [&](auto doc_result) {
      ...
      size_t i = 0;
      for (auto field : object) {
        singlestage::raw_json_string key;
  ...
  bool value_search_unescaped_key() {
    ...
    SUBTEST("singlestage::unescapedkey", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      bool got_key = false;
      ASSERT_SUCCESS( doc_result.get(object) );
      for (auto field : object) {
    ...
    SUBTEST("singlestage::rawkey", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
      bool got_key = false;
      for (auto field : object) {
        singlestage::raw_json_string keyv;
  ...
  bool issue_1480() {
    ...
    SUBTEST("singlestage::issue_1480::object", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
    ...
    SUBTEST("singlestage::issue_1480::big-key", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
...
#if SIMDJSON_EXCEPTIONS
    SUBTEST("singlestage::issue_1480::object-iteration", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
    ...
    SUBTEST("singlestage::issue_1480::object-iteration-string-view", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
      size_t counter_version{0};
      size_t counter_version_major{0};
    ...
    SUBTEST("singlestage::issue_1480::original", test_singlestage_doc(json, [&](auto doc_result) {
      size_t counter{0};
    ...
    SUBTEST("singlestage::issue_1480::object-operator", test_singlestage_doc(json, [&](auto doc_result) {
      singlestage::object object;
      ASSERT_SUCCESS( doc_result.get(object) );
  ...
  bool iterate_object_exception() {
    ...
    ASSERT_TRUE(test_singlestage_doc(json, [&](auto doc_result) {
      size_t i = 0;
      for (singlestage::field field : doc_result.get_object()) {
  ...
  bool empty(simdjson::singlestage::object obj) {
    bool is_empty;
    ASSERT_SUCCESS(obj.is_empty().get(is_empty));
    ASSERT_TRUE(is_empty);
    return true;
  }
  bool value_to_object(simdjson::singlestage::value val) {
    singlestage::json_type t;
    ASSERT_SUCCESS(val.type().get(t));
    ASSERT_EQUAL(t, singlestage::json_type::object);
    simdjson::singlestage::object obj;
...
#if SIMDJSON_EXCEPTIONS
  bool value_to_object_except(simdjson::singlestage::value val) {
    singlestage::json_type t = val.type();
    ASSERT_EQUAL(t, singlestage::json_type::object);
    if(empty(simdjson::singlestage::object(val)) != true) { return false; }
    return true;
  }
  ...
  bool iterate_doc_object_count() {
    ...
    SUBTEST("singlestage::empty_doc_object", test_singlestage_doc(empty, [&](auto doc_result) {
        size_t count;
        ASSERT_RESULT( doc_result.type(), json_type::object );
    ...
    SUBTEST("singlestage::basic_doc_object", test_singlestage_doc(basic, [&](auto doc_result) {
        size_t count;
        ASSERT_RESULT( doc_result.type(), json_type::object );
        ASSERT_SUCCESS( doc_result.count_fields().get(count) );
        ASSERT_EQUAL( count, 5 );
  ...
  bool test_strager() {
    ...
    // return false.
    auto process = [](singlestage::object root) -> std::pair<bool,uint64_t> {
      ///////////////////////////////////////////////////////////
