...
bool test_ondemand(simdjson::parser &parser, const simdjson::padded_string &json, const F& f) {
...
template<typename F>
bool test_ondemand_doc(simdjson::parser &parser, const simdjson::padded_string &json, const F& f) {
