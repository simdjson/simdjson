#ifndef SIMDJSON_GENERIC_SINGLESTAGE_VALUE_ITERATOR_INL_H

#ifndef SIMDJSON_AMALGAMATED
#define SIMDJSON_GENERIC_SINGLESTAGE_VALUE_ITERATOR_INL_H
...
simdjson_inline simdjson_result<SIMDJSON_IMPLEMENTATION::singlestage::value_iterator>::simdjson_result(SIMDJSON_IMPLEMENTATION::singlestage::value_iterator &&value) noexcept
    : implementation_simdjson_result_base<SIMDJSON_IMPLEMENTATION::singlestage::value_iterator>(std::forward<SIMDJSON_IMPLEMENTATION::singlestage::value_iterator>(value)) {}
simdjson_inline simdjson_result<SIMDJSON_IMPLEMENTATION::singlestage::value_iterator>::simdjson_result(error_code error) noexcept
    : implementation_simdjson_result_base<SIMDJSON_IMPLEMENTATION::singlestage::value_iterator>(error) {}

} // namespace simdjson

#endif // SIMDJSON_GENERIC_SINGLESTAGE_VALUE_ITERATOR_INL_H