...
#if SIMDJSON_GENERIC_ONCE(SIMDJSON_GENERIC_ONDEMAND_ARRAY_INL_H)
#define SIMDJSON_GENERIC_ONDEMAND_ARRAY_INL_H SIMDJSON_GENERIC_INCLUDED(SIMDJSON_GENERIC_ONDEMAND_ARRAY_INL_H)
