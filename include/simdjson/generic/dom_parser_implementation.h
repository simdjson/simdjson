...
public:
  ...
  simdjson_warn_unused uint8_t *parse_string_safe(const uint8_t *src, uint8_t *dst, bool allow_replacement, const uint8_t *buf_end) const noexcept final;
  simdjson_warn_unused uint8_t *parse_wobbly_string(const uint8_t *src, uint8_t *dst) const noexcept final;
  simdjson_warn_unused uint8_t *parse_wobbly_string_safe(const uint8_t *src, uint8_t *dst, const uint8_t *buf_end) const noexcept final;
