...
public:
   ...
   */
  template<typename T>
  WARN_UNUSED simdjson_really_inline error_code get(T &value) const noexcept;
...
public:
  ...
  simdjson_really_inline simdjson_result<dom::element> operator[](const std::string_view &key) const noexcept;
  ...
  simdjson_really_inline simdjson_result<dom::element> at_key(const std::string_view &key) const noexcept;
  simdjson_really_inline simdjson_result<dom::element> at_key_case_insensitive(const std::string_view &key) const noexcept;
