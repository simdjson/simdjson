#ifndef SIMDJSON_SUNNYCOVE_SIMD_H
#define SIMDJSON_SUNNYCOVE_SIMD_H
...
namespace simd {
  ...
  template<typename T, typename Mask=uint64_t>
  struct base8: base<simd8<T>> {
    ...
    simdjson_really_inline Mask operator==(const simd8<T> other) const { return _mm512_cmpeq_epi8_mask(*this, other); }

    static const int SIZE = sizeof(base<T>::value);

    template<int N=1>
    simdjson_really_inline simd8<T> prev(const simd8<T> prev_chunk) const {
      __m512i prev_shufmask =  _mm512_set_epi64(0xd,0xc,0xb,0xa,0x9,0x8,0x7,0x6);
      return _mm512_alignr_epi8(*this, _mm512_permutex2var_epi64(prev_chunk, prev_shufmask, *this), 16 - N);
    }
  };
  ...
  struct simd8<bool>: base8<bool> {
    ...
    simdjson_really_inline uint64_t to_bitmask() const { return _mm512_movepi8_mask(*this); }
    //simdjson_really_inline bool any() const { return !_mm256_testz_si256(*this, *this); } //TODO
  ...
  struct base8_numeric: base8<T> {
    ...
    static simdjson_really_inline simd8<T> repeat_32(
    ...
    simdjson_really_inline void compress(uint64_t mask, L * output) const {
      ...
      shufmask =
      _mm512_add_epi8(shufmask, _mm512_set_epi32(0x18181818, 0x18181818,0x10101010, 0x10101010,
        0x08080808, 0x08080808, 0, 0,
        0x18181818, 0x18181818,0x10101010, 0x10101010,
        0x08080808, 0x08080808, 0, 0));
      ...
      //__m512i v256 = _mm512_castsi256_si512(
      //  _mm256_loadu_si256(reinterpret_cast<const __m256i *>(pshufb_combine_table + pop1 * 8)));
      __m512i compactmask = _mm512_shuffle_epi8(*this, shufmask);//= _mm256_insertf128_si256(v256,_mm256_loadu_si256(reinterpret_cast<const __m256i *>(pshufb_combine_table + pop3 * 8)), 1);
      ...
      __m256i v128;
      v128 = _mm512_castsi512_si256(almostthere);
      _mm256_storeu_si256( reinterpret_cast<__m256i *>(output), v128);
      //v128 = _mm512_extractf64x4_pd(almostthere, 1);
      _mm256_storeu_si256( reinterpret_cast<__m256i *>(output + 16 - count_ones(mask & 0xFFFF)), v128);
    }  //TODO
    ...
    simdjson_really_inline simd8<L> lookup_16(
      ...
      return lookup_16(simd8<L>::repeat_32(
  ...
  struct simd8<int8_t> : base8_numeric<int8_t> {
    ...
    // Repeat 16 values as many times as necessary (usually for lookup tables)
    simdjson_really_inline static simd8<int8_t> repeat_32(
      int8_t v0,  int8_t v1,  int8_t v2,  int8_t v3,  int8_t v4,  int8_t v5,  int8_t v6,  int8_t v7,
      int8_t v8,  int8_t v9,  int8_t v10, int8_t v11, int8_t v12, int8_t v13, int8_t v14, int8_t v15,
      int8_t v16,  int8_t v17,  int8_t v18, int8_t v19, int8_t v20, int8_t v21, int8_t v22, int8_t v23,
      int8_t v24,  int8_t v25,  int8_t v26, int8_t v27, int8_t v28, int8_t v29, int8_t v30, int8_t v31
    ...
    simdjson_really_inline uint64_t operator>(const simd8<int8_t> other) const { return _mm512_cmpgt_epi8_mask(*this, other); }
    simdjson_really_inline uint64_t operator<(const simd8<int8_t> other) const { return _mm512_cmpgt_epi8_mask(other, *this); }
  };
  ...
  struct simd8<uint8_t>: base8_numeric<uint8_t> {
    ...
    // Repeat 16 values as many times as necessary (usually for lookup tables)
    simdjson_really_inline static simd8<uint8_t> repeat_32(
      uint8_t v0,  uint8_t v1,  uint8_t v2,  uint8_t v3,  uint8_t v4,  uint8_t v5,  uint8_t v6,  uint8_t v7,
      uint8_t v8,  uint8_t v9,  uint8_t v10, uint8_t v11, uint8_t v12, uint8_t v13, uint8_t v14, uint8_t v15,
      uint8_t v16, uint8_t v17, uint8_t v18, uint8_t v19, uint8_t v20, uint8_t v21, uint8_t v22, uint8_t v23,
      uint8_t v24, uint8_t v25, uint8_t v26, uint8_t v27, uint8_t v28, uint8_t v29, uint8_t v30, uint8_t v31
    ...
    simdjson_really_inline uint64_t operator<=(const simd8<uint8_t> other) const { return _mm512_cmple_epu8_mask(*this, other); }
    simdjson_really_inline uint64_t operator>=(const simd8<uint8_t> other) const { return _mm512_cmpge_epu8_mask(*this, other); }
    ...
    simdjson_really_inline bool is_ascii() const {
      //uint32_t tmp_mask = _mm512_reduce_or_epi32(*this);
      //return (tmp_mask & 0x80808080) == 0;
      __m512i mask_ascii = _mm512_set1_epi8((char)(0x7f));
      return (bool)(_mm512_cmpgt_epu8_mask(*this,mask_ascii) == 0);
    }
    simdjson_really_inline bool bits_not_set_anywhere() const { return _mm512_testn_epi32_mask(*this, *this)>0; }
    simdjson_really_inline bool any_bits_set_anywhere() const { return !bits_not_set_anywhere(); }
    simdjson_really_inline bool bits_not_set_anywhere(simd8<uint8_t> bits) const { return _mm512_testn_epi32_mask(*this, bits); } //TODO
    ...
    template<int N>
    simdjson_really_inline simd8<uint8_t> shl() const { return simd8<uint8_t>(_mm512_srli_epi16(*this, N)) & uint8_t(0xFFu << N); }
    // Get one of the bits and make a bitmask out of it.
    // e.g. value.get_bit<7>() gets the high bit
    //template<int N>
    //simdjson_really_inline int get_bit() const { return _mm512_movemask_epi8(_mm512_slli_epi16(*this, 7-N)); } //TODO
  };
  ...
  struct simd8x64 {
    ...
    static_assert(NUM_CHUNKS == 1, "Sunnycove kernel should use one registers per 64-byte block.");
    ...
    simdjson_really_inline uint64_t compress(uint64_t mask, T * output) const {
      uint64_t mask1 = uint64_t(mask);
      this->chunks[0].compress(mask1, output);
      return 64 - count_ones(mask1);
    }
    ...
    simdjson_really_inline uint64_t to_bitmask() const {
      uint64_t r_lo = uint64_t(this->chunks[0].to_bitmask());
      return r_lo;
    }
...
#endif // SIMDJSON_SUNNYCOVE_SIMD_H
