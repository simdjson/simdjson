...
struct base8 : base<simd8<T>> {
  ...
  friend simdjson_constexpr Mask operator==(const simd8<T> lhs, const simd8<T> rhs) {
    return (simd_t)vec_cmpeq(lhs.value, (simd_t)rhs);
  }
...
template <> struct simd8<bool> : base8<bool> {
  using simd_t = typename base8<bool>::simd_t;
