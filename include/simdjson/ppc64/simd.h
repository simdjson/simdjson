...
template <typename Child> struct base {
  ...
  simdjson_constexpr operator const __m128i &() const {
    return this->value;
  }
...
template <> struct simd8<bool> : base8<bool> {
  ...
  simdjson_constexpr simd8<bool>(const __m128i _value)
      : base8<bool>(_value) {}
  // Splat constructor
...
template <typename T> struct base8_numeric : base8<T> {
  ...
  simdjson_constexpr base8_numeric(const __m128i _value)
      : base8<T>(_value) {}
...
template <> struct simd8<int8_t> : base8_numeric<int8_t> {
  ...
  simdjson_constexpr simd8(const __m128i _value)
