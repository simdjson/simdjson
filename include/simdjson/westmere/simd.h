...
namespace simd {
  ...
  struct base {
    ...
    simdjson_constexpr Child operator&(const Child other) const { return _mm_and_si128(*this, other); }
    simdjson_constexpr Child operator^(const Child other) const { return _mm_xor_si128(*this, other); }
    simdjson_constexpr Child bit_andnot(const Child other) const { return _mm_andnot_si128(other, *this); }
  ...
  struct base8_numeric: base8<T> {
    ...
    simdjson_constexpr simd8<T> operator+(const simd8<T> other) const { return _mm_add_epi8(*this, other); }
    simdjson_constexpr simd8<T> operator-(const simd8<T> other) const { return _mm_sub_epi8(*this, other); }
  ...
  struct simd8<int8_t> : base8_numeric<int8_t> {
    ...
    simdjson_constexpr simd8<int8_t> max_val(const simd8<int8_t> other) const { return _mm_max_epi8(*this, other); }
    simdjson_constexpr simd8<int8_t> min_val(const simd8<int8_t> other) const { return _mm_min_epi8(*this, other); }
    simdjson_constexpr simd8<bool> operator>(const simd8<int8_t> other) const { return _mm_cmpgt_epi8(*this, other); }
    simdjson_constexpr simd8<bool> operator<(const simd8<int8_t> other) const { return _mm_cmpgt_epi8(other, *this); }
  };
  ...
  struct simd8<uint8_t>: base8_numeric<uint8_t> {
    ...
    // Array constructor
    simdjson_constexpr simd8(const uint8_t* values) : simd8(load(values)) {}
    // Member-by-member initialization
    simdjson_constexpr simd8(
    ...
    // Saturated math
    simdjson_constexpr simd8<uint8_t> saturating_add(const simd8<uint8_t> other) const { return _mm_adds_epu8(*this, other); }
    simdjson_constexpr simd8<uint8_t> saturating_sub(const simd8<uint8_t> other) const { return _mm_subs_epu8(*this, other); }

    // Order-specific operations
    simdjson_constexpr simd8<uint8_t> max_val(const simd8<uint8_t> other) const { return _mm_max_epu8(*this, other); }
    simdjson_constexpr simd8<uint8_t> min_val(const simd8<uint8_t> other) const { return _mm_min_epu8(*this, other); }
    ...
    simdjson_constexpr bool is_ascii() const { return _mm_movemask_epi8(*this) == 0; }
    simdjson_constexpr bool bits_not_set_anywhere() const { return _mm_testz_si128(*this, *this); }
    simdjson_constexpr bool any_bits_set_anywhere() const { return !bits_not_set_anywhere(); }
    simdjson_constexpr bool bits_not_set_anywhere(simd8<uint8_t> bits) const { return _mm_testz_si128(*this, bits); }
    simdjson_constexpr bool any_bits_set_anywhere(simd8<uint8_t> bits) const { return !bits_not_set_anywhere(bits); }
    template<int N>
    simdjson_constexpr simd8<uint8_t> shr() const { return simd8<uint8_t>(_mm_srli_epi16(*this, N)) & uint8_t(0xFFu >> N); }
    template<int N>
    simdjson_constexpr simd8<uint8_t> shl() const { return simd8<uint8_t>(_mm_slli_epi16(*this, N)) & uint8_t(0xFFu << N); }
    // Get one of the bits and make a bitmask out of it.
    // e.g. value.get_bit<7>() gets the high bit
    template<int N>
    simdjson_constexpr int get_bit() const { return _mm_movemask_epi8(_mm_slli_epi16(*this, 7-N)); }
  };
