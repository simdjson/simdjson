...
numberparsingcheck:tests/numberparsingcheck.cpp $(HEADERS) $(LIBFILES)
	...
	$(CXX) $(CXXFLAGS) -o numberparsingcheck $(LIBFILES) tests/numberparsingcheck.cpp -I. $(LIBFLAGS) -DJSON_TEST_NUMBERS
...
stringparsingcheck:tests/stringparsingcheck.cpp $(HEADERS) $(LIBFILES)
	$(CXX) $(CXXFLAGS) -o stringparsingcheck $(LIBFILES) tests/stringparsingcheck.cpp -I. $(LIBFLAGS) -DJSON_TEST_STRINGS
